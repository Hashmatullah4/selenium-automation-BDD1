...
public class CreateAmazonAccountSteps extends BaseTest {
    ...
    @When("I will enter {string} as value for your name field")
    public void iWillEnterAsValueForYourNameField(String arg0) {
        
    }

    @And("I will enter {string} as value for email field")
    public void iWillEnterAsValueForEmailField(String arg0) {
    }

    @And("I will enter {string} as a valid password value for password field")
    public void iWillEnterAsAValidPasswordValueForPasswordField(String arg0) {
    }
}
